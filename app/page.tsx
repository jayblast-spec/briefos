...
const product = {"repo":"BriefOS","suite":"AI Productivity Suite","category":"Executive briefing","audience":"founders, operators, consultants, and leadership teams","promise":"compress scattered context into a board-ready decision brief","inputLabel":"Messy context, notes, or meeting dump","placeholder":"Paste customer feedback, strategy notes, or project updates","primary":"Build brief","gradient":"from-blue-300 via-cyan-200 to-slate-200","metrics":["2 min brief","Source-backed","Decision-ready"],"modules":["Context compression","Decision options","Risk and assumption map","Action owner table","Board memo export"],"outputs":["One-page brief","Options and tradeoffs","Recommended next action","Follow-up questions"],"pricing":"Free first brief, $29/month Solo, $129/month Team briefing room."} as const;
